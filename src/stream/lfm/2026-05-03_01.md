...
from_repo: lossless-group/lossless-flavored-markdown-package
from_ref: main
from_sha: d96b5474234be443619b252773931ba88a346444
site_uuid: 07061634-575e-4b42-808d-4429637a291d
hex_code: sh3wvp
date_authored_initial_draft: 2026-05-03
date_authored_current_draft: 2026-05-03
date_created: 2026-05-03
date_modified: 2026-05-03
title: "LFM Inline Link Substitutions: OG fetch foundation + `:::link-preview` / `:::link-rollup` directives end-to-end"
lede: "First end-to-end vertical slice of inline link substitution — URL classifier → OG fetcher → `:::link-preview` / `:::link-rollup` directives → Astro card renderer, with all eight spec formats rendering real OpenGraph metadata on the page."
publish: true
authors:
  - Michael Staton
augmented_with:
...
tags:
  ...
  - Link-Preview
  - Link-Rollup
  - Inline-Link-Substitution
  - Directives
  - Remark-Plugin
  - OpenGraph
  - Astro-Components
files_changed:
  - packages/lfm/src/utils/og-cache.ts
  - packages/lfm/src/utils/og-dispatcher.ts
  - packages/lfm/src/utils/classify-link.ts
  - packages/lfm/src/utils/og-backends/index.ts
  - packages/lfm/src/utils/og-backends/direct.ts
  - packages/lfm/src/utils/og-backends/opengraph-io.ts
  - packages/lfm/src/utils/og-backends/frontmatter-only.ts
  - packages/lfm/src/plugins/og-fetcher.ts
  - packages/lfm/src/plugins/remark-link-preview.ts
  - packages/lfm/src/types/index.ts
  - packages/lfm/src/index.ts
  - packages/lfm/src/preset.ts
  - packages/lfm/tsup.config.ts
  - packages/lfm/package.json
  - sites/mpstaton-site/src/components/markdown/LinkPreviewCard.astro
  - sites/mpstaton-site/src/components/markdown/LinkRollup.astro
  - sites/mpstaton-site/src/components/markdown/AstroMarkdown.astro
  - sites/mpstaton-site/src/lib/promote/memos.ts
  - sites/mpstaton-site/src/content/promote/_demo/memo/v1.md
  - sites/mpstaton-site/.gitignore
---
