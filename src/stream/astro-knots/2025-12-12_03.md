...
from_ref: master
from_sha: d4af5927346a20c8c6a0836d7f811b1e638a81cf
site_uuid: 607e82cd-a667-4feb-97ee-ee197db51c81
hex_code: jt2h1v
title: "Hypernova Site — Private GitHub Content Fetching for Confidential Memos"
lede: "Confidential memos stream from a private repository through a fine-grained token, with the file path derived automatically from the URL slug. None of that content ever touches the deployed build."
summary: "Parent-level record of work done in the hypernova-site submodule: the github-content library, slug-to-path derivation, local demo mode, and configuration. Company names in the worked examples are genericized — the real memo set is the diligence pipeline the feature exists to protect. The submodule carries its own copy of this entry."
publish: true
