...
from_ref: master
from_sha: 96f88c17bfacaa232c455ed567a65735ca50f083
site_uuid: 677daa26-aa11-4703-b32a-68e45b3cbe9d
hex_code: e1bc3g
title: "LFM Inline Link Substitutions — OG Fetch Foundation and the link-preview / link-rollup Directives"
lede: "The first end-to-end slice of inline link substitution: paste a URL, get a card. Eight render formats now exercise the spec, with styling polish and rate-limit tuning still open."
summary: "Phase 0 of the OG fetch foundation in @lossless-group/lfm plus the :::link-preview and :::link-rollup directives wired end to end. _demo/memo/v1.md exercises all eight formats (row, card, thumb, livesite, column, gallery and others). Known-open at time of writing: visual polish across formats and rate-limit tuning. Read before extending the directive family."
publish: true
