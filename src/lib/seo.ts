...
/** Every format the compose pipeline produces. Generated by scripts/og-compose. */
export const SHARE_IMAGES = {
  banner:     { path: "/ogimage__Lossless-Changelog--Banner.jpg",     width: 1200, height: 630,  type: "image/jpeg" },
  square:     { path: "/ogimage__Lossless-Changelog--Square.jpg",     width: 1080, height: 1080, type: "image/jpeg" },
  bannerTall: { path: "/ogimage__Lossless-Changelog--BannerTall.jpg", width: 900,  height: 1200, type: "image/jpeg" },
  portrait:   { path: "/ogimage__Lossless-Changelog--Portrait.jpg",   width: 1080, height: 1350, type: "image/jpeg" },
  /**
   ...
   * all crop to roughly this shape, so a 16:9 banner gets letterboxed or
   * crop-zoomed while this lands in the viewport nearly whole.
   */
  messages:   { path: "/ogimage__Lossless-Changelog--Messages.jpg",   width: 890,  height: 760,  type: "image/jpeg" },
